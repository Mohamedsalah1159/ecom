...
<head>
    ...
    <link href="{{ asset('assets/css/ecom.css') }}" rel="stylesheet">
            ...
            <div class="nk-sidebar nk-sidebar-fixed is-light" data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand h-100 text-left">
                        <a href="{{ route('user-dashboard') }}" class="logo-link nk-sidebar-logo w-80px ob-contain">
                            <img class="logo-img" src="{{ logo() }}" alt="{{ config('app.name') }}">
                        </a>
                    </div>
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">{{ __('Stores') }}</h6>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin-users') }}" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">{{ __('All Stores') }}</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin-create-user') }}" class="nk-menu-link">
                                        <span class="nk-menu-icon">
                                            <em class="icon ni ni-user-add"></em>
                                         </span>
                                        <span class="nk-menu-text">{{ __('Create Store') }}</span>
                                    </a>
                                </li><!-- .nk-menu-item -->

                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">{{ __('Package') }}</h6>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="{{ route('admin-packages') }}" class="nk-menu-link">
                                        ...
                                        <span class="nk-menu-text">{{ __('All Packages') }}</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">{{ __('Others') }}</h6>
                                </li>
                                <li class="nk-menu-item">
